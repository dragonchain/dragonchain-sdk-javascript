...
var readFileAsync = function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
    return [2 /*return*/, ''];
}); }); };
if (fs_1.readFile)
...
var DragonchainClient = /** @class */ (function () {
    ...
    function DragonchainClient(endpoint, credentials, verify, injected) {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (options.permissionsDocument)
                                body['permissions_document'] = options.permissionsDocument;
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (options.permissionsDocument)
                            body['permissions_document'] = options.permissionsDocument;
                        return [4 /*yield*/, this.put("/v1/api-key/" + options.keyId, body)];
                    case 1: return [2 /*return*/, (_a.sent())];
                }
            });
        }); };
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.delete("/v1/contract/txn_type/" + options.transactionType)];
         ...
         */
        this.createBinanceInterchain = function (options) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var body;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!options.name)
                            throw new FailureByDesign_1.FailureByDesign('PARAM_ERROR', 'Parameter `name` is required');
                        if (options.rpcPort && !Number.isInteger(options.rpcPort))
                            throw new FailureByDesign_1.FailureByDesign('PARAM_ERROR', 'Parameter `rpcPort` must be an integer');
                        if (options.apiPort && !Number.isInteger(options.apiPort))
                            throw new FailureByDesign_1.FailureByDesign('PARAM_ERROR', 'Parameter `apiPort` must be an integer');
                        body = { version: '1', name: options.name };
                        if (typeof options.testnet === 'boolean')
                            body.testnet = options.testnet;
                        if (options.privateKey)
                            body.private_key = options.privateKey;
                        if (options.nodeURL)
                            body.node_url = options.nodeURL;
                        if (options.rpcPort)
                            body.rpc_port = options.rpcPort;
                        if (options.rpcPort)
                            body.api_port = options.apiPort;
                        return [4 /*yield*/, this.post("/v1/interchains/binance", body)];
                    case 1: return [2 /*return*/, (_a.sent())];
                }
            });
        }); };
         ...
         */
        this.updateBinanceInterchain = function (options) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var body;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (options.apiPort)
                            body.api_port = options.apiPort;
                        return [4 /*yield*/, this.patch("/v1/interchains/binance/" + options.name, body)];
                    case 1: return [2 /*return*/, (_a.sent())];
                }
            });
        }); };
         ...
         */
        this.signBinanceTransaction = function (options) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var body;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!options.name)
                            throw new FailureByDesign_1.FailureByDesign('PARAM_ERROR', 'Parameter `name` is required');
                        if (!options.amount)
                            throw new FailureByDesign_1.FailureByDesign('PARAM_ERROR', 'Parameter `amount` is required');
                        if (!options.toAddress)
                            throw new FailureByDesign_1.FailureByDesign('PARAM_ERROR', 'Parameter `toAddress` is required');
                        body = {
                            version: '1',
                        ...
                        return [4 /*yield*/, this.post("/v1/interchains/binance/" + options.name + "/transaction", body)];
                    case 1: return [2 /*return*/, (_a.sent())];
                }
            });
        }); };
         ...
         */
        this.publishInterchainTransaction = function (options) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var body;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!options.signedTransaction)
                            throw new FailureByDesign_1.FailureByDesign('PARAM_ERROR', 'Parameter `signedTransaction` is required');
                        body = {
                            version: '1',
                            blockchain: options.blockchain,
                            name: options.name,
                        ...
                        return [4 /*yield*/, this.post('/v1/interchains/transaction/publish', body)];
                    case 1: return [2 /*return*/, (_a.sent())];
                }
            });
        }); };
         ...
         */
        this.queryInterchainTransactions = function (options) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!options.blockId)
                            throw new FailureByDesign_1.FailureByDesign('PARAM_ERROR', 'Parameter `blockId` is required');
                        return [4 /*yield*/, this.get("/v1/verifications/interchains/" + options.blockId)];
                    case 1: return [2 /*return*/, (_a.sent())];
                }
            });
        }); };
         ...
         */
        this.getReport = function (options) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var transaction, blockId, block, verifications, l5verifications;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!options.transactionId)
                            throw new FailureByDesign_1.FailureByDesign('PARAM_ERROR', 'Parameter `transactionId` is required');
                        return [4 /*yield*/, this.getTransaction({ transactionId: options.transactionId })];
                    case 1:
                        transaction = _a.sent();
                        if (transaction && !transaction.ok)
                            return [2 /*return*/, { ok: false, status: transaction.status, response: {} }];
                        blockId = transaction.response.header.block_id;
                        return [4 /*yield*/, this.getBlock({ blockId: blockId })];
                    case 2:
                        block = _a.sent();
                        if (block && !block.ok)
                            return [2 /*return*/, { ok: false, status: block.status, response: {} }];
                        return [4 /*yield*/, this.getVerifications({ blockId: blockId })];
                    case 3:
                        verifications = _a.sent();
                        return [4 /*yield*/, this.queryInterchainTransactions({ blockId: blockId })];
                    case 4:
                        l5verifications = _a.sent();
                        return [2 /*return*/, {
                                ok: true,
                                status: 200,
                                response: {
