...
describe('DragonchainClient', function () {
    ...
    describe('GET', function () {
        ...
        describe('.queryInterchainTransactions', function () {
            it('calls #fetch() with correct params', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, client.queryInterchainTransactions({ blockId: '123456789' })];
                        case 1:
                            _a.sent();
                            sinon_1.assert.calledWith(fetch, 'fakeUrl/v1/verifications/interchains/123456789', expectedFetchOptions);
                            return [2 /*return*/];
                    }
                });
            }); });
        ...
        describe('.getSmartContractSecret', function () {
            it('calls readFileAsync with correct dragonchain id and secret name', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        describe('.queryTransactions', function () {
            ...
            it('defaults offset and limit', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, client.queryTransactions({
        ...
        describe('.getSmartContractLogs', function () {
            ...
            it('calls #fetch() with correct params and missing erroneous ?', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
    ...
    describe('DELETE', function () {
        ...
        describe('.deleteSmartContract', function () {
            it('calls #fetch() with correct params (smart contract ID)', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var param;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            it('calls #fetch() with correct params (transaction type)', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var param;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            param = 'banana';
                            return [4 /*yield*/, client.deleteSmartContract({ transactionType: param })];
                        case 1:
                            _a.sent();
                            sinon_1.assert.calledWith(fetch, 'fakeUrl/v1/contract/txn_type/banana', expectedFetchOptions);
                            return [2 /*return*/];
                    }
                });
            }); });
    ...
    describe('POST', function () {
        ...
        describe('.createApiKey', function () {
            it('calls #fetch() with correct params', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, client.createApiKey({ nickname: 'mynickname', permissionsDocument: { version: '1', default_allow: true, permissions: {} } })];
                        case 1:
                            _a.sent();
                            expectedBody = { nickname: 'mynickname', permissions_document: { version: '1', default_allow: true, permissions: {} } };
                            sinon_1.assert.calledWith(fetch, 'fakeUrl/v1/api-key', tslib_1.__assign(tslib_1.__assign({}, expectedFetchOptions), { body: JSON.stringify(expectedBody) }));
                            return [2 /*return*/];
                    }
                });
            }); });
            ...
            it('calls #fetch() with correct params', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            obj = tslib_1.__assign(tslib_1.__assign({}, expectedFetchOptions), { body: JSON.stringify(expectedBody) });
        ...
        describe('.createSmartContract', function () {
            it('create custom contract successfully', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            ...
            it('calls #fetch() with correct params', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            obj = tslib_1.__assign(tslib_1.__assign({}, expectedFetchOptions), { body: JSON.stringify(fakeBody) });
        ...
        describe('.createBinanceInterchain', function () {
            it('calls #fetch() with correct params', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var fakeBody, obj;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, client.createBinanceInterchain({ name: 'banana', testnet: true, privateKey: 'abcd', nodeURL: 'some IP', rpcPort: 1234, apiPort: 5678 })];
                        case 1:
                            _a.sent();
                            obj = tslib_1.__assign(tslib_1.__assign({}, expectedFetchOptions), { body: JSON.stringify(fakeBody) });
                            sinon_1.assert.calledWith(fetch, 'fakeUrl/v1/interchains/binance', obj);
                            return [2 /*return*/];
                    }
                });
            }); });
        ...
        describe('.signBinanceTransaction', function () {
            it('calls #fetch() with correct params', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var fakeBody, obj;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, client.signBinanceTransaction({ name: 'banana', amount: 123, toAddress: 'receiver addy', symbol: 'TOKEN', memo: 'for bananas' })];
                        case 1:
                            _a.sent();
                            obj = tslib_1.__assign(tslib_1.__assign({}, expectedFetchOptions), { body: JSON.stringify(fakeBody) });
                            sinon_1.assert.calledWith(fetch, 'fakeUrl/v1/interchains/binance/banana/transaction', obj);
                            return [2 /*return*/];
                    }
                });
            }); });
        ...
        describe('.publishInterchainTransaction', function () {
            it('calls #fetch() with correct params', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var fakeBody, obj;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, client.publishInterchainTransaction({ name: 'banana', blockchain: 'bitcoin', signedTransaction: 'banana' })];
                        case 1:
                            _a.sent();
                            obj = tslib_1.__assign(tslib_1.__assign({}, expectedFetchOptions), { body: JSON.stringify(fakeBody) });
                            sinon_1.assert.calledWith(fetch, 'fakeUrl/v1/interchains/transaction/publish', obj);
                            return [2 /*return*/];
                    }
                });
            }); });
    ...
    describe('PUT', function () {
        ...
        describe('.updateApiKey', function () {
            it('calls #fetch() with correct params', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, client.updateApiKey({ keyId: 'someKeyId', nickname: 'mynickname', permissionsDocument: { version: '1', default_allow: true, permissions: {} } })];
                        case 1:
                            _a.sent();
                            expectedBody = { nickname: 'mynickname', permissions_document: { version: '1', default_allow: true, permissions: {} } };
                            sinon_1.assert.calledWith(fetch, 'fakeUrl/v1/api-key/someKeyId', tslib_1.__assign(tslib_1.__assign({}, expectedFetchOptions), { body: JSON.stringify(expectedBody) }));
                            return [2 /*return*/];
                    }
                });
            }); });
            ...
            it('calls #fetch() with correct params', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            obj = tslib_1.__assign(tslib_1.__assign({}, expectedFetchOptions), { body: JSON.stringify(fakeBodyResponse) });
    ...
    describe('PATCH', function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, client.updateEthereumInterchain({ name: 'banana', privateKey: 'abcd', rpcAddress: 'some rpc', chainId: 12 })];
                        case 1:
                            _a.sent();
                            obj = tslib_1.__assign(tslib_1.__assign({}, expectedFetchOptions), { body: JSON.stringify(fakeBody) });
        ...
        describe('.updateBinanceInterchain', function () {
            it('calls #fetch() with correct params', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var fakeBody, obj;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, client.updateBinanceInterchain({ name: 'banana', testnet: true, privateKey: 'abcd', nodeURL: 'some IP', rpcPort: 1234, apiPort: 5678 })];
                        case 1:
                            _a.sent();
                            obj = tslib_1.__assign(tslib_1.__assign({}, expectedFetchOptions), { body: JSON.stringify(fakeBody) });
                            sinon_1.assert.calledWith(fetch, 'fakeUrl/v1/interchains/binance/banana', obj);
                            return [2 /*return*/];
                    }
                });
            }); });
