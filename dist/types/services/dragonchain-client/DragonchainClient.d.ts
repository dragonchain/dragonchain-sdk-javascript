...
export declare class DragonchainClient {
    ...
    createApiKey: (options?: {
         ...
         */
        permissionsDocument?: PermissionsDocument | undefined;
     ...
     */
    createBinanceInterchain: (options: {
        /**
         * The name of the network to update
         */
        name: string;
    ...
    }) => Promise<Response<BinanceInterchainNetwork>>;
    /**
     * Update an existing binance wallet/network for interchain use
     */
    updateBinanceInterchain: (options: {
        /**
         * The name of the network to update
         */
        name: string;
     ...
     */
    signBinanceTransaction: (options: {
        /**
     ...
     */
    publishInterchainTransaction: (options: {
        /**
         * The blockchain type to set (i.e. 'bitcoin', 'ethereum')
         */
        blockchain: SupportedInterchains;
    ...
    }) => Promise<Response<PublishedInterchainTransaction>>;
    /**
     ...
     */
    queryInterchainTransactions: (options: {
        /**
         * L1 block ID
         */
        blockId: string;
    }) => Promise<Response<L5BlockAtRest[]>>;
    /**
    ...
    getReport: (options: {
         ...
         */
        transactionId: string;
    }) => Promise<Response<EternalReportV1>>;
    /**
     * @hidden
     */
    getTimestamp(): string;
